  ...
  const handleImportAll = () => {
    ...
    draftTasks.forEach(draft => {
      addTask({
        ...
        subtasks: draft.subtasks.map((s, idx) => ({ id: `${Date.now()}-${idx}`, title: s.title, completed: s.completed })),
      });
    });
            ...
            <View className="gap-6">
              <View>
                <Text className="text-on-surface-variant font-medium text-xs leading-relaxed mb-4">
                  Pour your raw thoughts into the box below. Write or speak naturally about what needs to get done, the urgency, and complexity. The AI will instantly convert it to categorized backlog tasks.
                </Text>
