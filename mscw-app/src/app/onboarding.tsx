          ...
          <View className="flex-1 items-center justify-center p-6">
            ...
            {step === 0 && (
              <View className="items-center w-full max-w-sm">
                ...
                <Text className="text-lg text-on-surface-variant text-center mb-10 leading-relaxed">
                  Constraint-driven productivity forces you to prioritize. Capping your day prevents burnout and guarantees high-impact focus.
                </Text>
              </View>
            )}
            ...
            {step === 1 && (
              <View className="items-center w-full max-w-sm">
                ...
                <Text className="text-lg text-on-surface-variant text-center mb-10 leading-relaxed">
                  Estimate complexity, not time. Use 1, 2, 3, 5, or 8 points. An 8 is a massive epic; a 1 is a tiny fix.
                </Text>
              </View>
            )}
